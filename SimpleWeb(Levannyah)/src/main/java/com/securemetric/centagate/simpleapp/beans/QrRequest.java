...
public class QrRequest implements Serializable {
    ...
    public String getQrRequest() throws Exception {
        ...
        if ("0".equals(code)) {
            ...
            FacesContext.getCurrentInstance().getExternalContext().redirect("login-qr.xhtml");
            return null;
        } else {
