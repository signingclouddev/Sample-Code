...
public class PushRequest implements Serializable {
    ...
    public String getPushRequest() throws Exception {
        ...
        String input = "Mobile Push Notification Test";
        ...
        if ("0".equals(code)) {
            ...
            FacesContext.getCurrentInstance().getExternalContext().getSessionMap().put("authMethod", "PUSH");

            FacesContext.getCurrentInstance().getExternalContext().redirect("login-push.xhtml");
            return null;
        } else {
