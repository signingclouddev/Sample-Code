...
@ManagedBean(name="transactionAuthorize")
@SessionScoped
public class TransactionAuthorize implements Serializable {
    ...
    public String authorizeTransaction() throws Exception {
        ...
        if ("0".equals(code)) {
            ...
            candidates.countVotes();

            FacesContext.getCurrentInstance().getExternalContext().redirect("transaction-success.xhtml");
