...
@ManagedBean(name="crotpLogin")
@SessionScoped
public class CrotpLogin implements Serializable {
    ...
    public CrotpLogin() {
        ...
        this.challenge = FacesContext.getCurrentInstance().getExternalContext().getSessionMap().get("otpChallenge").toString();
    }
    ...
    public void displayOtpChallenge() throws Exception {

        FacesContext.getCurrentInstance().getExternalContext().redirect("login-crotp.xhtml");
    }

    public String crotpAuth() throws Exception {
