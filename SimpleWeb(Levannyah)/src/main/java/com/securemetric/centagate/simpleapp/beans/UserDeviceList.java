...
@ManagedBean(name="userDeviceList")
public class UserDeviceList implements Serializable {
    ...
    public String getUserDeviceList() throws Exception {
        System.out.println("User Device List");
        ...
        System.out.println("Retrieved JSON: " + retJson);
        ...
        if ("0.0".equals(code)) {
            if (deviceList.isEmpty()) {
                ...
                for (Map<String, Object> device : deviceList) {
                    ...
                    this.deviceName = (String) device.get("deviceName");
                    this.deviceModel = (String) device.get("deviceModel");
                    this.deviceHid = (String) device.get("deviceHid");
                    this.accountId = (String) device.get("accountId");
            ...
            FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "Error!", "Oops, something went wrong"));
        }
        return null;
