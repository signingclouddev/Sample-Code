...
private String strHMAC = null;
    public HashMap<String , String> Authenticate(String username, String devAccId, String ipAddress, String userAgent, String authToken) 
    {
        /*requestOtpChallenge*/
        ...
        map.put ( "hmac" , secureRestClientTrustManager.calculateHmac256 (
                   secretKey , 
                   username + devAccId + integrationKey + unixTimestamp + authToken + ipAddress + userAgent));
        if (authToken != null) {
        ...
        WebResource service = client.resource ( APIController.getAuthURI()+  "/req/requestOtpChallenge"  );
