...
public class SMSTransAuth {
    ...
    public HashMap<String , String> requestSmsOtp(String username , String details, String transId, String ipAddress,String userAgent) 
    {
        /*requestSmsOtp*/
        ...
        /* Send the POST request for authentication */ 
        WebResource service = client.resource ( APIController.getAuthURI()+  "/req/requestSmsTransOtp"  );
    ...
    public HashMap<String , String> Authenticate(String username, String smsOtp, String details, String transId,  String ipAddress,String userAgent) 
    {
        /*authSmsOtp*/
        ...
        ClientResponse response = service.accept ( MediaType.APPLICATION_JSON ).post ( ClientResponse.class , gson.toJson ( map ) );
        System.out.println("DEBUG Message[smsmtranauth] : Call getStatus " +  response.getStatus());
         /* Read the output returned from the authentication */ 
        if(response.getStatus() == 200)
        {    
            authString = response.getEntity ( String.class ) ; 
