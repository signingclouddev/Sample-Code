...
//            authString = qrAuth.Authenticate(username, password,authToken,ipAddress,userAgent, details);  
    ...
    public HashMap<String, String> Transaction(String username, String devAccId, String authMethod, String otp, String otpChallenge, String authToken, String qrPlainText, String ipAddress, String userAgent, String browserFp, String transValue, String details) {
        ...
        if (authMethod.equals("2")) {
            SMSTransAuth smsTransAuth = new SMSTransAuth();
//            authString = smsAuth.Authenticate(username, otp, authToken, ipAddress, userAgent, browserFp, dblTrans.toString());
...
//            authString = crOtpAuth.Authenticate(username, devAccId , otp, otpChallenge, authToken, ipAddress, userAgent, browserFp, dblTrans.toString());
