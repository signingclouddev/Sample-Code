...
public class PkiAuth {
    ...
    public HashMap<String , String> Authenticate(String username, String certFingerPrint, String authToken, String ipAddress, String userAgent, String browserFp, String transValue) 
    {
        /*authPki*/
        ...
        WebResource service = client.resource ( APIController.getAuthURI()+  "/auth/authPki"  );
