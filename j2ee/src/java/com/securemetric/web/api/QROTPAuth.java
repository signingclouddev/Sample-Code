...
public class QROTPAuth {
    ...
    public HashMap<String , String> Authenticate(String username, String devAccId, String otp, String challenge, String authToken, String qrPlainText, String ipAddress, String userAgent, String browserFp, String transValue) 
    {
        ...
        map.put ( "hmac" , secureRestClientTrustManager.calculateHmac256 (
                   secretKey , 
                   username + devAccId + otp + challenge + details + integrationKey + unixTimestamp + authToken + ipAddress + userAgent + browserFp )); 
        ...
        WebResource service = client.resource ( APIController.getAuthURI()+  "/auth/authQrCode" );
