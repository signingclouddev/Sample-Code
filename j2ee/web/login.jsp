...
<%
    ...
    String qnaDisplay = "";
    String fidoDisplay = "";
    String crPushAuthDisplay = "";
    String mobileSoftCertDisplay = "";
    String smsAuth = "";
    String crOtpAuth = "";
    String otpAuth = "";
    String pkiAuth = "";
    ...
    if (returnCode != null && returnCode.equals("0")) {
        ...
        mobileSoftCertAuth = (String) request.getSession().getAttribute("MSOFTCERT");
    ...
    if (crPushAuth == null) {
        crPushAuthDisplay = "style=\"visibility: hidden\"";
    }
    if (mobileSoftCertAuth == null) {
        mobileSoftCertDisplay = "style=\"visibility: hidden\"";
    }
...
<HTML>
    <HEAD>
        ...
        <script type="text/javascript" src="javascript/JSLoginInvoke.js"></script>
        <script language="javascript">
            ...
            function closeAlert()
            {
                document.getElementById('error-message').style.display = 'none';
                document.getElementById('fade').style.display = 'none';
                window.document.FORM.action = baseURL + "/LoginServlet?MODE=CLEAR";
            ...
            function authReq(req)
            {
                if (CheckMandatory(window.document.FORM))
                {
                    ...
                    if (req == '8') {
                        window.document.FORM.btnSMSLogin.disabled = true;
                        getLoginInvoke("8","<%=userid%>","<%=password%>");
                    }
                    ...
                    if (req == '10') {
                        window.document.FORM.btnSMSLogin.disabled = true;
                        getLoginInvoke("10","<%=userid%>","<%=password%>");
                    }
                                        ...
                                        <TABLE cellSpacing=1 cellPadding=1 width="100%" border=0>
                                            ...
                                            <TBODY> 
                                                ...
                                                <TR align="center">
                                                    ...
                                                    <TD><INPUT onclick="authReq('8');" name="btnCrPushLogin" type="button" value="" class=imgCrPush <%=crPushAuth != null ? classStyle : classStyle2%> <%=crPushAuthDisplay%> ></TD>
                                                    ...
                                                    <TD><INPUT onclick="authReq('10');" name="btnMobileSoftCert" type="button" value="" class=imgMobileSoftCert <%=mobileSoftCertAuth != null ? classStyle : classStyle2%> <%=mobileSoftCertDisplay%> ></TD>
                                                </TR>
