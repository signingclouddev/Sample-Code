...
//				{
    ...
    <body>
        		<object CLASSID="clsid:52B60D69-D689-4A91-AF63-7B4168592F05" id="bpi" codebase="Centagate.ocx" src="Centagate.ocx">
		</object>
<br/><br/><br/><br/>
...
<br/><br/>
			...
			<a href="#"><IMG style="Z-INDEX: 102; LEFT: 16px; POSITION: absolute; TOP: 16px" src="images/logo.png"></a>
