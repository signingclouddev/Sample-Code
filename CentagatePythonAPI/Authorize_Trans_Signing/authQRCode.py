...
hmacdata = str(username) + str(devAccId) + str(otp) + str(challenge) + str(authToken) +  str(integrationKey) + str(unixTimestamp) + str(ipAddress) + str(userAgent) + str(browserFp) + str(supportFido)
