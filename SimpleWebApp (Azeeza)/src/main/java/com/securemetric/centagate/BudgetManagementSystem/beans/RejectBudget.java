...
@ManagedBean(name="rejectBudget")
@SessionScoped
public class RejectBudget implements Serializable {
    ...
    public String getRequestTransactionSigningMobilePushCRApi() throws Exception {
        ...
        if ("0".equals(code)) {
            ...
            FacesContext.getCurrentInstance().getExternalContext().redirect("pushMobileNotificationSignReject.xhtml");
            return null;
        }
        else {
            System.out.println("Code:" + code);
