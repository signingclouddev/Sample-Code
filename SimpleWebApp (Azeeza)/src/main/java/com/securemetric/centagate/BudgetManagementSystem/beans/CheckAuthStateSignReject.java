...
@ManagedBean(name="checkAuthStateSignReject")
@SessionScoped
public class CheckAuthStateSignReject implements Serializable {
    ...
    public CheckAuthStateSignReject() {
                ...
                if(connection != null) {
                    ...
                    if(resultSet.next()) {
                        ...
                        if(rowsUpdated > 0) {
                            ...
                            FacesMessage mssg = new FacesMessage(FacesMessage.SEVERITY_INFO, "Success", "The status is Changed to Rejected.");
