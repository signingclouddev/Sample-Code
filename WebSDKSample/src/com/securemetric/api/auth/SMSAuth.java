...
public class SMSAuth {
    ...
    public HashMap<String , String> requestSmsOtp(String username) 
    {
        /*requestSmsOtp*/
    ...
    public HashMap<String , String> Authenticate(String username, String smsOtp) 
    {
        /*authSmsOtp*/
        ...
        map.put ( "hmac" ,APIController.calculateHmac256 (
                   secretKey , 
                   username + smsOtp + integrationKey + unixTimestamp + ipAddress + userAgent));
    ...
    public static void main(String[] args) throws Exception {
        ...
        authString = smsAuth.requestSmsOtp(username);
        ...
        if( code == 0) { /* status code 0 = Success */
            ...
            authString = smsAuth.Authenticate(username, inputSMSOtp);
